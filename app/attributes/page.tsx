    ...
    <>
      ...
      <div className="flex justify-center flex-wrap items-start content-start min-h-screen border border-red-500 p-0 m-[108px] mt-[67px]">
        <div className="relative flex justify-center flex-wrap p-0 m-0 h-[416px] w-[634px]">
          ...
          <div className="font-custom text-[42px] font-[600] text-center absolute mt-[222px] leading-[51px]">attributes give you higher chances of getting hired</div>
        </div>
        ...
        <div className="relative flex justify-center flex-wrap p-0 m-0 h-[585px] w-[1220px]">
          <div className="absolute font-custom italic text-[21px] font-[400] text-center mt-[25px]">but be warned...</div>
          <div className="absolute font-custom italic text-[42px] font-[400] text-center mt-[65px]">not all attributes are positive</div>
          ...
          <div className="absolute font-custom italic text-[42px] font-[400] text-center mt-[495px]">reputation matters, maintain it</div>
        </div>
